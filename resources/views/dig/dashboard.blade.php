...
@section('content')
    @php
        // Container class untuk konsistensi layout
    ...
    <div class="bg-white">
        <div class="{{ $container }} mt-4">
            <div class="rounded-xl bg-white shadow-sm px-4 py-3 flex items-center justify-between">
                    ...
                    <div class="rounded-2xl border-2 border-[#7A1C1C] bg-white p-5">
                        ...
                        <div class="mt-4 flex justify-end">
                            <button type="button" 
                                ...
                                @else
                                    class="btn-toggle-progress inline-flex items-center gap-2 rounded-xl bg-[#7A1C1C] text-white px-3 py-2 text-sm shadow hover:bg-[#5a1515] cursor-pointer"
                                @endif
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24"
                                    fill="currentColor">
                                        ...
                                        <div id="editProgress-{{ $pr->id }}" class="hidden mb-3">
                                            <form method="POST"
                                                ...
                                                <div class="rounded-xl bg-[#F8E9E9] border border-[#C89898] px-3 py-2 text-xs text-[#7A1C1C] flex items-center">
                                                    Target: {{ (int)$pr->desired_percent }}% (otomatis)
                                                </div>
...
@section('scripts')
    {{-- Script untuk toggle form progress --}}
    <script>
