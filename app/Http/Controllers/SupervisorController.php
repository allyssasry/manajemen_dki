...
class SupervisorController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            if ($u->role !== 'kepala_divisi') {
                abort(403, 'Akses khusus Kepala Divisi.');
            }
            return $next($request);
        });
    }
    ...
    {
        return redirect()->route('kd.progresses');
    }
...
public function notifications(Request $request)
{
    ...
    return view('kd.notifications', compact('today','unreadCount'));
}
