...
class AccountController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            ...
            // Hapus avatar lama bila ada (di disk public)
            ...
            // Simpan ke kolom standar 'avatar'
            $update['avatar'] = $path;
        }
            ...
            if (!empty($user->{$col})) {
                ...
                try {
                    if (Storage::disk('public')->exists($p)) {
                        return Storage::disk('public')->url($p).'?v='.Storage::disk('public')->lastModified($p);
                    }
                } catch (\Throwable $e) {}
            }
        }
